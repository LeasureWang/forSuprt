...
<script type="text/javascript">
	$(function(){
		$(".delete").click(function(){
			...
			var flag = confirm("are you sure delete this " + label + " info?");
			if(flag){
...
<body>
	...
	<c:if test="${page != null && page.numberOfElements > 0 }">
		<table border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				<td colspan="8">
					total ${page.totalElements } records
					total ${page.totalPages } page
					current is ${page.number + 1 } page
					<a href="?pageNo=${page.number + 1 - 1 }">up</a>
					<a href="?pageNo=${page.number + 1 + 1 }">down</a>
				</td>
			</tr>
